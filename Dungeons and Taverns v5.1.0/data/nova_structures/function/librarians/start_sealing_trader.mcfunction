...
advancement revoke @s only nova_structures:give_sealing_trader_trade
...
execute as @e[type=villager,tag=dnt_librarian_sealing,distance=..15,sort=nearest] unless entity @s[tag=trade2added] run tag @s add dnt_librarian_sealing_schedule
...
schedule function nova_structures:librarians/scheduled_librarian_sealing 1t
