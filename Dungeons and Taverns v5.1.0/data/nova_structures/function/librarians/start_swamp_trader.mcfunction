...
advancement revoke @s only nova_structures:give_swamp_trader_trade
...
execute as @e[type=villager,tag=dnt_librarian_swamp,distance=..15,sort=nearest] unless entity @s[tag=trade2added] run tag @s add dnt_librarian_swamp_schedule
...
schedule function nova_structures:librarians/scheduled_librarian_swamp 1t