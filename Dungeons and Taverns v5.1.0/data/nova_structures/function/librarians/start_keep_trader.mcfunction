...
advancement revoke @s only nova_structures:give_keep_trader_trade
...
execute as @e[type=villager,tag=dnt_librarian_keep,distance=..5,sort=nearest] unless entity @s[tag=trade2added] run tag @s add dnt_librarian_keep_schedule
...
schedule function nova_structures:librarians/scheduled_librarian_keep 1t
