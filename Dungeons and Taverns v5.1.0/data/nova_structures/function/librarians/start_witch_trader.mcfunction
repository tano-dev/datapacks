...
advancement revoke @s only nova_structures:give_witch_trader_trade
...
execute as @e[type=villager,tag=dnt_librarian_witch,distance=..15,sort=nearest] unless entity @s[tag=trade2added] run tag @s add dnt_librarian_witch_schedule
...
schedule function nova_structures:librarians/scheduled_librarian_witch 1t