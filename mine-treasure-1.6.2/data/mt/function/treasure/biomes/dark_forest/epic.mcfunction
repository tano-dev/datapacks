...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/dark_forest/epic",CustomName:{"text":"   Epic Dark Forest Treasure","color":"dark_red","bold":false,"italic":false}} destroy
