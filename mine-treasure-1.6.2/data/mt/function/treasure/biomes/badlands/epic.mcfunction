...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/badlands/epic",CustomName:{"text":"     Epic Badlands Treasure","color":"dark_red","bold":false,"italic":false}} destroy
