...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/badlands/common",CustomName:{"text":"   Common Badlands Treasure","color":"white","bold":false,"italic":false}} destroy
