...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/mushroom/common",CustomName:{"text":"   Common Mushroom Treasure","color":"white","bold":false,"italic":false}} destroy
