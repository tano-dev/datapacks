...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/ocean/common",CustomName:{"text":"     Common Ocean Treasure","color":"white","bold":false,"italic":false}} destroy
