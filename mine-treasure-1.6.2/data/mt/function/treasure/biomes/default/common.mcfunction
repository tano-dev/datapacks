...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/default/common",CustomName:{text:"     Common Default Treasure",color:"white",bold:false,italic:false}} destroy
