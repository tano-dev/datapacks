...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/nether/common",CustomName:{"text":"    Common Nether Treasure","color":"white","bold":false,"italic":false}} destroy
