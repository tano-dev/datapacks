...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/crimson/common",CustomName:{"text":"Common Crimson Forest Treasure","color":"white","bold":false,"italic":false}} destroy
