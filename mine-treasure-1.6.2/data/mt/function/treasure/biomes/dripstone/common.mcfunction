...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/dripstone/common",CustomName:{"text":"  Common Dripstone Treasure","color":"white","bold":false,"italic":false}} destroy
