...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/swamp/common",CustomName:{"text":"     Common Swamp Treasure","color":"white","bold":false,"italic":false}} destroy
