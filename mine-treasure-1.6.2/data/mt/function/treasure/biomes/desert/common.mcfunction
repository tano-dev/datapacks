...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/desert/common",CustomName:{"text":"    Common Desert Treasure","color":"white","bold":false,"italic":false}} destroy
