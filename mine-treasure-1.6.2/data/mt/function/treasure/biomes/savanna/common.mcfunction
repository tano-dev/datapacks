...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/savanna/common",CustomName:{"text":"   Common Savanna Treasure","color":"white","bold":false,"italic":false}} destroy
