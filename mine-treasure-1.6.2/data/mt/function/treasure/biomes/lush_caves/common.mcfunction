...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/lush_caves/common",CustomName:{"text":" Common Lush Caves Treasure","color":"white","bold":false,"italic":false}} destroy
