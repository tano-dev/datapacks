...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/lush_caves/rare",CustomName:{"text":"   Rare Lush Caves Treasure","color":"blue","bold":false,"italic":false}} destroy
