...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/taiga/common",CustomName:{"text":"     Common Taiga Treasure","color":"white","bold":false,"italic":false}} destroy
