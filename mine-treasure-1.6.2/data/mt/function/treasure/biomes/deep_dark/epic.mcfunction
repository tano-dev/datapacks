...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"mt:chests/deep_dark/epic",CustomName:{"text":"    Epic Deep Dark Treasure","color":"dark_red","bold":false,"italic":false}} destroy
