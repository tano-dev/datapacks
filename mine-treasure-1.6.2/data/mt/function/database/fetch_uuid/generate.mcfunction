...
execute unless score @s mt.uuid.0 matches -2147483648.. run function mt:database/fetch_uuid/zzz/store_uuid

execute store result score 0= mt.main run scoreboard players operation 1= mt.main = @s mt.uuid.0
...
execute store result score 0= mt.main run scoreboard players operation 1= mt.main = @s mt.uuid.1
...
execute store result score 0= mt.main run scoreboard players operation 1= mt.main = @s mt.uuid.2
...
execute store result score 0= mt.main run scoreboard players operation 1= mt.main = @s mt.uuid.3
