...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.6 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.7 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.8 add_multiplied_base
...
#======Skeleton=====#
execute as @e[type=minecraft:skeleton,tag=h-nigh.mob,tag=!h-nigh.not_skeleton_horse,scores={h-nigh.y=60..}] at @s run function h-nigh:ref/tick/events/super_moon/horde_mobs/skeletons/skeleton_horse
#==Generic==#
...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.6 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.7 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.8 add_multiplied_base
# extreme speed normal
execute if score #difficulty h-nigh.config matches 4 run enchant @e[type=minecraft:skeleton,tag=h-nigh.mob] power 4


#=======Stray=======#
execute as @e[type=minecraft:stray,tag=h-nigh.mob,tag=!h-nigh.not_stray_horse,scores={h-nigh.y=60..}] at @s run function h-nigh:ref/tick/events/super_moon/horde_mobs/skeletons/stray_horse
#==Generic==#
...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.6 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.7 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:generic.movement_speed modifier add h-nigh:horde_swift 0.8 add_multiplied_base
# extreme speed normal
