...
execute as @e[type=#h-nigh:zombified,tag=h-nigh.mob,tag=!h-nigh.regened] unless entity @s[nbt={IsBaby:1}] run attribute @s minecraft:zombie.spawn_reinforcements base set 0.5
...
#=====Baby=====#
#==Generic==#
execute as @e[type=#h-nigh:zombified,tag=h-nigh.mob,nbt={IsBaby:1},tag=!h-nigh.regened] run attribute @s minecraft:zombie.spawn_reinforcements base set 0.25
