...
#==Badlands Creeper==#
execute as @e[type=creeperoverhaul:badlands_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/badlands_creeper/bunk_blood"}
...
#====Beach Creeper===#
execute as @e[type=creeperoverhaul:beach_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/beach_creeper/bunk_blood"}


#====Cave Creeper====#
execute as @e[type=creeperoverhaul:cave_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/cave_creeper/bunk_blood"}


#==Dark Oak Creeper==#
execute as @e[type=creeperoverhaul:dark_oak_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/dark_oak_creeper/bunk_blood"}


#===Desert Creeper===#
execute as @e[type=creeperoverhaul:desert_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/desert_creeper/bunk_blood"}


#==Dripstone Creeper=#
execute as @e[type=creeperoverhaul:dripstone_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/dripstone_creeper/bunk_blood"}


#====Hills Creeper===#
execute as @e[type=creeperoverhaul:hills_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/hills_creeper/bunk_blood"}


#===Jungle Creeper===#
execute as @e[type=creeperoverhaul:jungle_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/jungle_creeper/bunk_blood"}
...
#===Spruce Creeper===#
execute as @e[type=creeperoverhaul:spruce_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/spruce_creeper/bunk_blood"}


#====Swamp Creeper===#
execute as @e[type=creeperoverhaul:swamp_creeper,tag=h-nigh.mob,tag=!h-nigh.regened] run data merge entity @s {DeathLootTable:"h-nigh:entities/modded/swamp_creeper/bunk_blood"}