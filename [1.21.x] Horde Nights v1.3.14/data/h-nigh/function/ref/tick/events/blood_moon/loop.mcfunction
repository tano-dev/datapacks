...
#======Spawning======#
execute unless score phantom_spawning h-nigh.config matches 1 run function h-nigh:ref/tick/events/blood_moon/mob_spawning

#======Recruit=======#
function h-nigh:ref/tick/events/blood_moon/horde_mobs
...
execute as @e[tag=h-nigh.mob] if score @s h-nigh.vfx_random matches 20 at @s run particle minecraft:angry_villager ~ ~ ~1
execute as @e[tag=h-nigh.mob] if score @s h-nigh.vfx_random matches 40 at @s run particle minecraft:angry_villager ~1 ~ ~ 0 0 0 1 1 force
execute as @e[tag=h-nigh.mob] if score @s h-nigh.vfx_random matches 60 at @s run particle minecraft:angry_villager ~ ~ ~-1
...
execute unless score coward h-nigh.config matches 1 as @a unless score @s h-nigh.cowards matches 1..2 if score @s h-nigh.time_since_slay matches 2400.. unless score @s h-nigh.alive matches 1.. run scoreboard players set @s h-nigh.cowards 1
