...
execute unless score @s h-nigh.alive matches 1.. run scoreboard players add creeper_slay h-nigh.global_statistics 1

execute unless score @s h-nigh.alive matches 1.. run scoreboard players add @s h-nigh.horde_slay_stat 1
execute unless score @s h-nigh.alive matches 1.. run scoreboard players add @s h-nigh.creeper_slay_stat 1
...
advancement revoke @s only h-nigh:stats/mobs/slay/creepers/creeper