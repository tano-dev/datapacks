...
execute unless score @s h-nigh.alive matches 1.. unless score #event h-nigh.status matches 5 run scoreboard players add hill_creep_slay h-nigh.global_statistics 1
...
execute unless score @s h-nigh.alive matches 1.. unless score #event h-nigh.status matches 5 run scoreboard players add @s h-nigh.hill_creep_slay_stat 1
...
advancement revoke @s only h-nigh:stats/mobs/slay/creepers/modded/hills_creeper