...
tellraw @s {"text":" "}
tellraw @s [{"text":"[Set Difficulty]","color":"red","clickEvent":{"action":"suggest_command","value":"/scoreboard players set difficulty h-nigh.config "}},{"text":" (1 to 4)","color":"gray"},{"text":" [Reset to Default]","color":"red","clickEvent":{"action":"run_command","value":"/function h-nigh:config/gameplay/pg4/difficulty/default"}}]
tellraw @s {"text":" "}
tellraw @s [{"text":"<<<","bold":true,"color":"gold","clickEvent":{"action":"run_command","value":"/function h-nigh:config/gameplay/pg1"}},{"text":" "},{"text":"Pg3","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/function h-nigh:config/gameplay/pg3"}},{"text":" ... ","bold":true,"color":"gold"},{"text":"COMING SOON!!!","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/function h-nigh:config/gameplay/pg5"}}]
tellraw @s {"text":"[Refresh Page]","color":"dark_aqua","bold":true,"clickEvent":{"action":"run_command","value":"/function h-nigh:config/gameplay/pg4"}}
