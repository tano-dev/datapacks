...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.1 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.2 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:bogged,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.3 add_multiplied_base
...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.1 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.2 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:skeleton,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.3 add_multiplied_base
# extreme speed normal
...
execute if score #difficulty h-nigh.config matches 1..2 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.1 add_multiplied_base
# easy speed normal
...
#====Hard===#
execute if score #difficulty h-nigh.config matches 3 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.2 add_multiplied_base
# hard speed normal
...
#==Extreme==#
execute if score #difficulty h-nigh.config matches 4 as @e[type=minecraft:stray,tag=h-nigh.mob] run attribute @s minecraft:movement_speed modifier add h-nigh:horde_swift 0.3 add_multiplied_base
# extreme speed normal
