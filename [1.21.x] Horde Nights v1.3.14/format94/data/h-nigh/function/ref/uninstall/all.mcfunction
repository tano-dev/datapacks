...
tellraw @a {"text":"Uninstalling ALL related RRC data used by Horde Nights:","color":"dark_red"}
tellraw @a {"text":"If you have any other RRC pack installed, you may experience issues until world reload.","color":"red"}
tellraw @s {"text":" "}
...
scoreboard objectives remove rrc.init
scoreboard objectives remove rrc.horde_night
tellraw @a {"text":"Shared Scoreboards Removed","color":"red"}
tellraw @s {"text":" "}
