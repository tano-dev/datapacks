...
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.5,0.0,0.0]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[-0.5,0.0,0.0]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,0.0,0.5]}
summon small_fireball ~ ~4 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,0.0,-0.5]}
