...
summon area_effect_cloud ~ ~0.25 ~ {Particle:{type:large_smoke},custom_particle:{type:large_smoke},ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:10}
summon area_effect_cloud ~ ~0.25 ~ {Particle:{type:raid_omen},custom_particle:{type:raid_omen},ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:10}
