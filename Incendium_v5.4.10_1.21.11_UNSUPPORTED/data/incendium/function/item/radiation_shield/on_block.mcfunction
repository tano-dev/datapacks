...
summon area_effect_cloud ~ ~0.5 ~ {Particle:{type:dust, color:[0,1,0],scale:2},custom_particle:{type:dust, color:[0,1,0],scale:2},ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:8}
